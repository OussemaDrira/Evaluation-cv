...
def matching():
    ...
    'TypeScript', 'Rust', 'Perl', 'MATLAB', 'Objective-C', 'HTML', 'CSS',
    'Bootstrap', 'Tailwind CSS', 'React.js', 'Angular', 'Vue.js', 'Node.js', 'Express.js','Node js',
    ...
    'Leadership', 'Empathy', 'Flexibility', 'Critical thinking', 'Stress management', 'Conflict resolution', 'Decision-making', 'Working under pressure', 'Self-confidence', 'Organization',
...
def match():
    ...
    # Anglais
     ...
     'Teamwork', 'Adaptability', 'Problem-solving', 'Time management', 'Creativity',
